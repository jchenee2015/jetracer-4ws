...
class vehEnv:
    ...
    def step(self, action, throttle,P,I,D): 
        ...
        print(self.xseq)
        self.data = np.append(self.data,[[self.Xnew,self.Ynew,self.vxfilt,self.vx,throttle,self.x0d[0],self.x0d[1],self.Angnew,self.n,self.distoff,self.u,self.timediff,P,I,D]],axis = 0)
